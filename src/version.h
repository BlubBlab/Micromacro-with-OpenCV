...
namespace AutoVersion{
	...
	static const char UBUNTU_VERSION_STYLE[] =  "27.10";
	...
	static const long BUILD_SUB  = 19;
	static const long REVISION  = 1005;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 1381;
	#define RC_FILEVERSION 1,92,46,1006
	#define RC_FILEVERSION_STRING "1, 92, 47,19, 1005\0"
	static const char FULLVERSION_STRING [] = "1.92.47.19.1005";
